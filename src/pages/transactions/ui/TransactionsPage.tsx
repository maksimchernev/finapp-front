...
export function TransactionsPage({
  ...
  const groups = useMemo(
    () => groupTransactionsByLocalDate(transactions),
    [transactions],
  );
      ...
      <AnimatePresence>
            ...
            <form className={styles.filterForm} onSubmit={applyFilters}>
              <div className={styles.filterFields}>
                ...
                <label>
                  Банк
                  <select
                    value={draftFilters.bankId}
                    onChange={(event) =>
                      updateFilter("bankId", event.target.value)
                    }
                  >
              ...
              <button
                className={clsx(styles.primaryButton, styles.filterApplyButton)}
                type="submit"
              >
                Применить
              </button>
        ...
        {isBulkDeleteOpen && (
          ...
          >
            ...
            {bulkDeleteError && (
              <p className={styles.errorText}>{bulkDeleteError}</p>
            )}
...
function TransactionCard({
  ...
  const details = [category?.nameRu, transaction.bank?.name]
    .filter(Boolean)
    .join(" • ");
