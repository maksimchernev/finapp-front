...
- [x] **Step 1: Add failing boundary and parser tests**
...
- [x] **Step 4: Reuse both helpers in `areReviewDraftsValid`**
...
- [x] **Step 5: Run both tests and confirm GREEN**
...
- [x] **Step 1: Add failing incremental-input and save tests**
...
- [x] **Step 3: Store signed review text without coercion**
...
- [x] **Step 4: Parse once during batch save**
...
- [x] **Step 1: Add failing UI-bound and payload tests**
...
- [x] **Step 3: Add native bounds and invalid styling**
...
- [x] **Step 4: Add submit-time guards**
...
- [x] **Step 1: Add failing nearest-date tests**
...
- [x] **Step 2: Run the OCR date test and confirm RED**
...
- [x] **Step 3: Implement and apply the pure repair**
...
- [x] **Step 4: Run OCR parser tests and confirm GREEN**
...
- [x] **Step 1: Run focused amount/date/OCR tests**
...
- [x] **Step 2: Run build, full baseline, and diff check**
